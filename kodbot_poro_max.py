...
def handle_message(update):
    ...
    # ─── Web Project States ───
        ...
        _handle_web_project_name(user_id, text, chat_id)
    
    elif st == "web_group_name":
        _handle_web_group_name(user_id, text, chat_id)
    
    # ─── Enterprise States ───
    elif st == "enterprise_company_name":
        _handle_enterprise_company_name(user_id, text, chat_id)
    
    elif st == "enterprise_description":
        _handle_enterprise_description(user_id, text, chat_id)
    
    elif st == "enterprise_user_count":
        _handle_enterprise_user_count(user_id, text, chat_id)
